...
import { ArrowLeft, Loader2, Ruler, GlassWater, Wrench } from "lucide-react";
// Import catalogul de prețuri
import catalog from "../data/catalog.json";

export default function BalustradeConfiguratorPage() {
  // Extrage datele din catalog
  ...
  const calculatePrice = async () => {
    ...
    // Calcule folosind datele din catalog
    ...
    const vat = subtotal * catalog.general.vatRate;
