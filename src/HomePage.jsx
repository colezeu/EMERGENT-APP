...
const PRODUCTS = [
  ...
  { id: "inchidere-terasa", name: "Închidere Mobilă Terase", tagline: "Multitrack · Frameless · Ghilotină",        price: "de la 380€/m²", path: "/configurator/inchidere-terasa", desc: "Sisteme de închidere terase și balcoane: multitrack, frameless full-glass sau ghilotină verticală.", active: false },
  ...
  { id: "pergola",          name: "Pergole",                  tagline: "Bioclimatică · Sticlă · Sandwich",          price: "de la 420€/m²", path: "/configurator/pergola",          desc: "Pergole bioclimatice cu lamele orientabile, acoperiș din sticlă culisant sau panou sandwich.", active: false },
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <section style={{ minHeight: "100vh", display: "flex", alignItems: "center" }}>
          <div style={{ maxWidth: 1200, margin: "0 auto", width: "100%", padding: "140px 32px 100px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", marginTop: 80, border: "1px solid rgba(255,255,255,0.1)", borderRadius: 16, overflow: "hidden", background: "rgba(255,255,255,0.04)", backdropFilter: "blur(16px)" }} className="anim-fade-up-4">
              {STATS.map((s, i) => (
