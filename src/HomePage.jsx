...
const PRODUCTS = [
  ...
  { id: "pergola-copertina", name: "Pergolă & Copertină",           tagline: "Bioclimatică · Sticlă · Spider",   price: "de la 350€/m²", path: "/configurator/pergola-copertina", desc: "Pergole bioclimatice sau cu acoperiș sticlă. Copertine cu tiranți, consolă sau suport spider." },
...
export default function HomePage() {
  return (
    <div style={{ minHeight: "100vh", background: "#0f1117", color: "#f0ede8" }}>
      ...
      <footer style={{ padding: "32px", borderTop: "1px solid rgba(255,255,255,0.07)", textAlign: "center", color: "rgba(240,237,232,0.25)", fontSize: "0.82rem" }}>
